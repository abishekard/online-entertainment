...
public class HomeVideoAdapter extends RecyclerView.Adapter<HomeVideoAdapter.VideoViewHolder> {
    ...
    public HomeVideoAdapter(ArrayList<VideoInfo> videoList, Context context) {
    ...
    public VideoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_video_list_design,parent,false);
