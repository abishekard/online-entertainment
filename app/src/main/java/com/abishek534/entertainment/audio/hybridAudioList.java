...
import com.abishek534.entertainment.video.HybridVideoListClickPlay;
...
public class hybridAudioList extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener, MediaPlayer.OnCompletionListener,
    ...
    private ImageView audioSurface;
    ...
    private TextView bottomAudioTitle;
    private TextView audioLikes;
    private TextView audioViews;
    private ImageButton audioLiked;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hybrid_audio_list);
        ...
        bottomAudioTitle= findViewById(R.id.hybrid_audio_title);
        audioLikes = findViewById(R.id.hybrid_audio_likes);
        audioViews = findViewById(R.id.hybrid_audio_views);
        audioLiked = findViewById(R.id.hybrid_audio_liked);
      ...
      /*  surfaceHolder = hVideoSurface.getHolder();
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Play(audioList.get(videoPosition).getAudioUrl());
            }
        }, 2000);
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        if (videoPosition == audioList.size() - 1) {
            //hide next
    ...
    public void populatVideoList() {
        if (audioList.size() > 0) {
            linearLayoutManager = new LinearLayoutManager(hybridAudioList.this);
            linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
            // linearLayoutManager.setReverseLayout(true);
            // linearLayoutManager.setStackFromEnd(true);
            adapter = new AudioAdapter(audioList,hybridAudioList.this);
            ...
            Toast.makeText(hybridAudioList.this, "no video", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void statusBarInfullScreen() {
        Window window = hybridAudioList.this.getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(hybridAudioList.this.getResources().getColor(R.color.transparent));
            window.setNavigationBarColor(hybridAudioList.this.getResources().getColor(R.color.transparent));
    ...
    public void statusBarInnHalfscreen() {
        Window window = hybridAudioList.this.getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(hybridAudioList.this.getResources().getColor(R.color.black));
            window.setNavigationBarColor(hybridAudioList.this.getResources().getColor(R.color.black));
        }
    ...
    public void next() {
        ...
        if (videoPosition < audioList.size() - 1) {
            ...
            setCurrentVideoInfoToUi(audioList.get(videoPosition).getAudioUrl());
            ...
            editor.putString("lastPlayed", audioList.get(videoPosition).getAudioUrl());
            editor.apply();
    ...
    public void setCurrentVideoInfoToUi(String nextVideoPath) {
        ...
        videoTopName.setText(audioList.get(videoPosition).getAudioTitle());
        Picasso.get().load(audioList.get(videoPosition).getThumbUrl()).into(audioSurface);
        audioViews.setText(audioList.get(videoPosition).getViews());
        audioLikes.setText(audioList.get(videoPosition).getLikes());
        bottomAudioTitle.setText(audioList.get(videoPosition).getAudioTitle());
        audioLiked.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int lke = Integer.parseInt(audioList.get(videoPosition).getLikes())+1;
                FirebaseDatabase.getInstance().getReference().child("audios").child(audioList.get(videoPosition).getAudioId()).
                        child("likes").setValue(lke+"");
                Toast.makeText(hybridAudioList.this,"you liked this song ",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onStart() {
        ...
        if (in != 0) {
            ...
            final String mPath = audioList.get(vPosition).getAudioUrl();
    ...
    void executeSettingAtStartup() {
        ...
        sets = PreferenceManager.getDefaultSharedPreferences(hybridAudioList.this);
    ...
    public void videoClickListener(int position) {
        ...
        if(hPlayer != null) {
            ...
            Play(audioList.get(position).getAudioUrl());
        }
    }
